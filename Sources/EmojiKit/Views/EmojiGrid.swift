...
///
/// This view renders a non-scrolling grid. Use ``EmojiGridScrollView`` to
/// render a `ScrollView`-wrapped grid view that applies correct grid paddings
/// and automatically scrolls to the `selection`.
///
